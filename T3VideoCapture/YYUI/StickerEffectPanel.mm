...
- (void)initTab {
    ...
    // unselect
    NSString* imagePath = [NSString stringWithFormat:@"%@/images/close.png",
...
- (void)updateTab {
    ...
    for (int i = 0; i < itemCount; ++i) {
        ...
        if (tab.thumb.length > 0) {
            ...
            NSString* imagePath = [NSString stringWithFormat:@"%@/images/thumb.png",
                                   [[NSBundle mainBundle] bundlePath]];
            tab.thumbView.image = [UIImage imageWithContentsOfFile:imagePath];
        }
        if (tab.selectedThumb.length > 0) {
            ...
            NSString* imagePath = [NSString stringWithFormat:@"%@/images/thumb.png",
                                   [[NSBundle mainBundle] bundlePath]];
            tab.selectedThumbView.image = [UIImage imageWithContentsOfFile:imagePath];
        }
    }
}
    ...
    for (int i = 0; i < itemCount; ++i) {
        ...
        if (effect.loadView == nil) {
            if (![[NSFileManager defaultManager] fileExistsAtPath:effect.path]) {
                NSString* imagePath = [NSString stringWithFormat:@"%@/images/download.png",
                                       [[NSBundle mainBundle] bundlePath]];
                UIImage* img = [UIImage imageWithContentsOfFile:imagePath];
...
- (void)selectEffect:(int)index {
    ...
    if (effect.downView != nil) {
        if (effect.loadView == nil) {
            ...
            NSString* imagePath = [NSString stringWithFormat:@"%@/images/loading.png",
                                   [[NSBundle mainBundle] bundlePath]];
            UIImage* img = [UIImage imageWithContentsOfFile:imagePath];
...
- (void)loadEffect:(NSString*)path {
    ...
    _stickerUtil->LoadEffect(_context, [path UTF8String]);
}
